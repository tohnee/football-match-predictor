...
TEAM_RAW: List[Dict[str, object]] = [
    ...
    },
    {
        ...
        "recent_form": ["W", "D", "W", "W", "L", "W", "W", "W"],
        "recent_goals_for": [2, 1, 3, 2, 0, 2, 3, 2],
        "recent_goals_against": [1, 1, 2, 1, 1, 0, 1, 0],
        "style": "counter",
    ...
    },
    {
        ...
        "recent_form": ["D", "W", "D", "W", "W", "L", "W", "D"],
        "recent_goals_for": [2, 1, 0, 3, 1, 1, 2, 1],
        "recent_goals_against": [2, 0, 0, 0, 0, 2, 1, 1],
        "style": "counter",
    ...
    },
    {
        ...
        "recent_form": ["D", "W", "W", "W", "W", "W", "W", "W"],
        "recent_goals_for": [1, 1, 3, 2, 3, 2, 3, 2],
        "recent_goals_against": [1, 0, 0, 1, 0, 1, 1, 1],
        "style": "possession",
    ...
    },
    {
        ...
        "recent_form": ["L", "D", "W", "W", "W", "W", "W", "W"],
        "recent_goals_for": [1, 2, 2, 3, 1, 2, 2, 4],
        "recent_goals_against": [2, 2, 1, 1, 0, 1, 0, 1],
        "style": "pressing",
    ...
    },
    {
        ...
        "recent_goals_for": [1, 1, 2, 1, 2, 2, 2, 1],
    ...
    },
    {
        ...
        "recent_form": ["D", "D", "W", "W", "W", "L", "D", "W"],
        "recent_goals_for": [2, 1, 2, 3, 2, 0, 1, 2],
        "recent_goals_against": [2, 1, 0, 1, 1, 1, 1, 1],
        "style": "counter",
    ...
    },
    {
        ...
        "recent_form": ["D", "W", "L", "D", "D", "D", "W", "L"],
        "recent_goals_for": [1, 2, 1, 1, 1, 0, 1, 0],
        "recent_goals_against": [1, 0, 2, 1, 1, 0, 0, 1],
        "style": "direct",
    ...
    },
    {
        ...
        "recent_goals_for": [1, 1, 1, 1, 2, 1, 2, 0],
        "recent_goals_against": [0, 0, 1, 1, 1, 1, 1, 2],
        "style": "counter",
    ...
    },
    {
        ...
        "recent_form": ["L", "D", "W", "D", "D", "D", "D", "L"],
        "recent_goals_for": [1, 1, 2, 2, 1, 2, 2, 0],
        "recent_goals_against": [2, 1, 0, 2, 1, 2, 2, 1],
        "style": "direct",
    ...
    },
    {
        ...
        "recent_form": ["W", "L", "D", "D", "D", "D", "W", "D"],
        "recent_goals_for": [1, 1, 1, 2, 1, 1, 3, 1],
        "recent_goals_against": [0, 2, 1, 2, 1, 1, 2, 1],
        "style": "park_bus",
        "key_players": [],
    },
    {
    ...
    },
    {
        ...
        "recent_form": ["L", "D", "D", "L", "D", "L", "D", "L"],
        "recent_goals_for": [0, 2, 1, 1, 1, 0, 0, 0],
        "recent_goals_against": [2, 2, 1, 3, 1, 3, 0, 1],
        "style": "park_bus",
        "key_players": [],
    },
    {
    ...
    # ======== 亚洲 ========
    {
        ...
        "form": 7, "market_value": 380, "formation": "4-3-3",
        "recent_form": ["L", "W", "W", "W", "D", "W", "W", "D"],
        "recent_goals_for": [1, 1, 2, 2, 2, 2, 2, 1],
        "recent_goals_against": [2, 0, 0, 1, 2, 1, 1, 1],
        "style": "possession",
    ...
    },
    {
        ...
        "recent_form": ["D", "L", "W", "W", "W", "L", "D", "D"],
        "recent_goals_for": [2, 1, 2, 3, 2, 0, 0, 1],
        "recent_goals_against": [2, 2, 1, 1, 1, 1, 0, 1],
        "style": "park_bus",
        "key_players": [],
    },
    {
        ...
        "form": 5, "market_value": 80, "formation": "4-4-2",
        "recent_form": ["L", "W", "L", "D", "D", "W", "D", "W"],
        "recent_goals_for": [1, 2, 0, 2, 1, 1, 2, 2],
        "recent_goals_against": [2, 1, 2, 2, 1, 0, 2, 1],
        "style": "park_bus",
    ...
    # ======== 大洋洲 ========
    {
        ...
        "form": 4, "market_value": 30, "formation": "4-4-2",
        "recent_form": ["L", "L", "D", "L", "L", "L", "L", "L"],
        "recent_goals_for": [0, 0, 0, 1, 1, 0, 1, 0],
        "recent_goals_against": [3, 2, 0, 3, 2, 1, 3, 3],
        "style": "park_bus",
    ...
    },
    {
        ...
        "form": 4, "market_value": 20, "formation": "4-4-2",
        "recent_form": ["D", "L", "L", "L", "L", "L", "L", "L"],
        "recent_goals_for": [1, 0, 0, 0, 1, 0, 1, 0],
        "recent_goals_against": [1, 1, 2, 1, 2, 3, 3, 1],
        "style": "park_bus",
        "key_players": [],
    },
    {
